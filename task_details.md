Build an anomaly detection engine/DDOS detection tool.
Linked Stage
3
Linked Track
DevOps
...
Have your server live and tool running at the announced deadline, then submit using the submission [link](https://forms.gle/cVBE8dkw6BCV8REo9).
...
Submission Link
https://forms.gle/cVBE8dkw6BCV8REo9
Points
100
Format: Integer
Pass Mark
